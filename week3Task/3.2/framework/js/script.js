  ...
  computed: {
    filteredUnits() {
      return this.allUnits.filter(
        (i) =>
          i.code.toLowerCase().match(this.unitObj.code.toLowerCase()) &&
          i.desc.toLowerCase().match(this.unitObj.desc.toLowerCase()) &&
          (i.type.toLowerCase().match(this.unitObj.type.toLowerCase()) ||
            this.unitObj.type == "All")
      );
    },
  },
}).mount("#app");
